...
class UpdateScreen extends StatefulWidget {
  ...
  UpdateScreen({Key key, this.productID}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        future: ProductService().getProduct(widget.productID),
              ...
              child: ListView(
                children: [
                  ...
                  SizedBox(
                    height: 45,
                    child: TextField(
                        controller: snapshot.data.isEmpty
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                        controller: snapshot.data.isEmpty
                            ? TextEditingController()
                            : TextEditingController(
                                text: snapshot.data[0]['price'].toString()),
                        cursorColor: mainColor,
